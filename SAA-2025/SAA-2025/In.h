...
namespace In
{
	...
	struct IN
	{ // T - разрешенный F - запрещенный L - символ-разделитель или оператор C - одинарная ковычка N - начало новой строки D - двойная ковычка
		// O - символ начала комментария S - пробельный символ
